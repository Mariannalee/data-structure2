...
from Difficulty import generate_jlpt_difficulty_plot
...
def background_task(file_path):
    try:
        ...
        plot_path = plot_path = generate_jlpt_difficulty_plot(user_id, df)
    ...
    def chat_reply():
        try:
            response = client.models.generate_content(
                ...
                contents=f"你是一個日文家家教，請為這篇文章進行評估，派段這篇文章的難易度：{user_message}",
            )
